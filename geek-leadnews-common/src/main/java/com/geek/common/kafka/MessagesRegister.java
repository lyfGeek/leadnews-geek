...
public class MessagesRegister implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Reflections reflections = new Reflections("com.geek");
        ...
        log.info(" ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ");
        log.info("scan kafka message result[{}]", messages);
        log.info(" ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ");
    }

    /**
     * 通过消息的类型名称，查找对应的 class 定义。
     *
     * @param type
     * @return
     */
