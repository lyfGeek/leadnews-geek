package com.geek.images.kafka.listener;
...
@Component
@Log4j2
public class HotArticleListener implements IKafkaListener<String, String> {
    ...
    @Autowired
    private IHotArticleImageService hotArticleImageService;
