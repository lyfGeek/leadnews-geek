...
public class Compute {
    ...
    public static void main(String[] args) {
        String content = "最近公司由于业务拓展，需要进行小程序相关的开发，本着朝全栈开发者努力，决定学习下Vue，去年 csdn 送了一本《Vue.js 权威指南》";
    ...
    public static String longestCommonSubstring(String strA, String strB) {
        ...
        /*
         * 初始化矩阵数据，matrix[0][0] 的值为 0，
         * 如果字符数组 chars_strA 和 chars_strB 的对应位相同，则 matrix[i][j] 的值为左上角的值加 1。
        ...
        /*
         * 矩阵中，如果 matrix[m][n] 的值不等于 matrix[m-1][n] 的值也不等于 matrix[m][n-1] 的值，
         * 则 matrix[m][n] 对应的字符为相似字符元，并将其存入 result 数组中。
         */
