...
////        log.info("将数据加入线程池进行执行，url：{}，handleType：{}", parseItem.getUrl(), parseItem.gethandleType());
////        CrawlerThreadPool.submit(() -> {
////            // 正向抓取
////            if (CrawlerEnum.handleType.FORWARD.name().equals(parseItem.gethandleType())) {
////                log.info("开始处理消息，url：{}，handleType：{}", parseItem.getUrl(), parseItem.gethandleType());
...
////            }
////
////            log.info("处理文章数据结束，url：{}，handleType：{}，耗时：{}", parseItem.getUrl(), parseItem.gethandleType(), System.currentTimeMillis() - currentTimeMillis);
////        });
//    }
//
//    /**
...
////        long currentTimeMillis = System.currentTimeMillis();
////        String url = null;
////        String handleTyep = null;
////        if (null != parseItem) {
////            url = parseItem.getUrl();
////            handleTyep = parseItem.gethandleType();
////            log.info("开始添加数据，url：{}，handleType：{}", url, handleTyep);
////            // 添加文章数据。
...
////            }
////        }
////        log.info("添加数据完成，url：{}，handleType：{}，耗时：{}", url, handleTyep, System.currentTimeMillis() - currentTimeMillis);
////    }
//
////    /**
////     * 发送消息，审核文章。
