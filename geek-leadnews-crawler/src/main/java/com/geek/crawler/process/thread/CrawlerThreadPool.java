//package com.geek.crawler.process.thread;
//
...
//     * 阻塞队列大小 10000
//     */
//    private static final ExecutorService executorService = new ThreadPoolExecutor(1, threadNum, 60L, TimeUnit.SECONDS, queue) {
//
//        @Override
